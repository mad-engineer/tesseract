...
public:
	 ...
	 * @see actions.
	 */
	QAction *createAction( const QString &action_name, const char *name, const QString &icon=QString() );
	QAction *createAction( const QString &action_name, const QString &name, const QString &icon=QString() );
	 ...
	 * @see menus.
	 */
	QMenu *createMenu( const QString &menu_name , const char *name , const QString &icon=QString() );
	QMenu *createMenu( const QString &menu_name , const QString &name , const QString &icon=QString() );
	...
	void xmlWindowsPositions( const QString &config_name , QXmlStreamWriter &xml );
