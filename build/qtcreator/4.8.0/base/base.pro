...
# Other Projects
PROJECT_INCLUDE_CONFIG = $$SOLUTION_INCLUDE_PATH/config
...
# Input Release Libs
PROJECT_LIB_CONFIG = $$SOLUTION_LIB_PATH/$$ARCHITECTURE_PATH_RELEASE/config
...
# Input Debug Libs
PROJECT_LIB_CONFIG_D = $$SOLUTION_LIB_PATH/$$ARCHITECTURE_PATH_DEBUG/config
...
SOURCES  = $$PROJECT_SOURCE_PATH/autocomplete.cpp \
	...
	CONFIG(Debug):LIBS += 	-lsvgcanvasd -lconfigd -loperationsd -lprojectsd -ldynamic_helpd \
							-L$$PROJECT_LIB_CONFIG_D \
							-L$$PROJECT_LIB_PROJECTS_D \
							-L$$PROJECT_LIB_DYNAMIC_HELP_D \
							-L$$PROJECT_LIB_OPERATIONS_D \
							-L$$PROJECT_LIB_SVGCANVAS_D 

	CONFIG(Release):LIBS =  -lsvgcanvas -lconfig -loperations -lprojects -ldynamic_help \
							-L$$PROJECT_LIB_CONFIG \
