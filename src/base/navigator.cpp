...
Navigator::Navigator(QWidget *parent) : BaseWidget(parent) 
{
	...
	setWindowIcon( QIcon(QApplication::applicationDirPath() + "/styles/default/images/browser.png"));
	createActions();
	createToolBar();
	createLayout();
	createConnections();
	...
	{
		QFile file( QApplication::applicationDirPath()+"/styles/default/mainwindow/widgets/navigator/navigator.css" );
	...
	{
		QFile file( QApplication::applicationDirPath()+"/styles/default/mainwindow/widgets/navigator/widgets/toolbar.css" );
...
void Navigator::drag_start( const QModelIndex & index )
{
	...
	drag->setPixmap( (QApplication::applicationDirPath() + "/styles/default/images/filenew.png") );
