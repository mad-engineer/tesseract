...
{
	widget_type=HELP;
	setWindowIcon( QIcon( QApplication::applicationDirPath() + "/styles/default/images/help.png" ) );
	...
	{
		QFile file( QApplication::applicationDirPath()+"/styles/default/mainwindow/widgets/help.css" );
...
void Help::create_buttons()
{
	...
	QAction *_back = new QAction( QIcon( QApplication::applicationDirPath() + "/styles/default/images/back.png" ), tr("&Back"), this );
	connect( _back, SIGNAL( triggered() ) , this, SLOT( back() ) );
	
	toolbar->addAction(_back);
	
	QAction *_forward = new QAction(QPixmap( QApplication::applicationDirPath() + "/styles/default/images/forward.png"),tr("&Forward"),this);
	connect( _forward, SIGNAL( triggered() ) , this, SLOT( forward() ) );
	
	toolbar->addAction(_forward);
	
	QAction *_go_home = new QAction(QPixmap( QApplication::applicationDirPath() + "/styles/default/images/gohome.bmp"),tr("&Go home"),this);
	connect( _go_home, SIGNAL( triggered() ) , this, SLOT( go_home() ) );
	
	toolbar->addAction(_go_home);
	
	search_button=new QPushButton(QPixmap( QApplication::applicationDirPath() + "/styles/default/images/find.png"), "Search:", this);
