...
VariableList::VariableList(QWidget * parent):BaseWidget(parent)
{
	...
	setWindowIcon( QIcon( QApplication::applicationDirPath() + "/styles/default/images/taskbar.png" ) );
	...
	reload_button->setIcon( QIcon( QApplication::applicationDirPath() + "/styles/default/images/reload.png" ) );
	...
	local_item->setIcon(0,QIcon( QApplication::applicationDirPath() + "/styles/default/images/personal.png"  ) );
	...
	//currently_item->setIcon(0,QIcon( QApplication::applicationDirPath() + "/styles/default/images/run.bmp"  ) );
	...
	{
		QFile file( QApplication::applicationDirPath()+"/styles/default/mainwindow/widgets/variables.css" );
...
void VariableList::line_ready(QString line)
{
	...
	else if( line.startsWith("~~whos:") )
	{
		...
		/*if( s.startsWith("*** dynamically") )
		{
			...
			last_root_item->setIcon(0,QIcon( QApplication::applicationDirPath() + "/styles/default/images/connect_established.png"  ) );
			QFont font(tree->font());
			font.setBold(true);
...
// 			last_root_item->setText(0,s.trimmed());
// 			last_root_item->setToolTip(0,s.trimmed());
// 			last_root_item->setIcon(0,QIcon( QApplication::applicationDirPath() + "/styles/default/images/personal.png"  ) );
// 			QFont font(tree->font());
// 			font.setBold(true);
// 			last_root_item->setFont(0,font);
		}
...
// 			last_root_item->setText(0,s.trimmed());
// 			last_root_item->setToolTip(0,s.trimmed());
// 			last_root_item->setIcon(0,QIcon( QApplication::applicationDirPath() + "/styles/default/images/run.png"  ) );
// 			QFont font(tree->font());
// 			font.setBold(true);
// 			last_root_item->setFont(0,font);
		}
...
void VariableList::send_whos_command_to_octave()
{
	...
	*/
	...
	octave_connection->command_enter("_ide_reload_variables_list( whos() );",false);
}
