...
MainWindow::MainWindow(OctaveConnection *oc, Session *session, QWidget *parent):BaseWidget(parent)
{
	...
	setWindowTitle("Tesseract ["+session->getProjectName()+"]");
	...
	closeMessage = new QMessageBox("Tesseract",
	...
	{
		QFile file( QApplication::applicationDirPath()+"/styles/default/mainwindow/mainwindow.css" );
	...
	//TODO: find a better way to avoid double code
	{
		QFile file( QApplication::applicationDirPath()+"/styles/default/mainwindow/menubar.css" );
	...
	//TODO: find a better way to avoid double code
	{
		QFile file( QApplication::applicationDirPath()+"/styles/default/mainwindow/toolbar/run.css" );
	...
	//TODO: find a better way to avoid double code
	{
		QFile file( QApplication::applicationDirPath()+"/styles/default/mainwindow/toolbar/matrix.css" );
	...
	//TODO: find a better way to avoid double code	
	{
		QFile file( QApplication::applicationDirPath()+"/styles/default/mainwindow/toolbar/help.css" );
	...
	//TODO: find a better way to avoid double code	
	{
		QFile file( QApplication::applicationDirPath()+"/styles/default/mainwindow/toolbar/docks.css" );
...
void MainWindow::createActions()
{
	...
	actionRunFile->setIcon(QIcon(QApplication::applicationDirPath() + "/styles/default/images/run.png"));
	actionRunFile->setText(QApplication::tr("Run an Octave Script"));

	actionOctave_help = new QAction(this);
	actionOctave_help->setIcon(QIcon(QApplication::applicationDirPath() + "/styles/default/images/help.png"));
	...
	actionTable->setIcon(QIcon(QApplication::applicationDirPath() + "/styles/default/images/table.png"));
	actionTable->setText(QApplication::tr("Table"));

	actionEditor = new QAction(this);
	actionEditor->setIcon(QIcon(QApplication::applicationDirPath() + "/styles/default/images/xedit.png"));
	...
	createAction("actionCommandList", tr("Command History"), (QApplication::applicationDirPath() + "/styles/default/images/history.png"));
...
void MainWindow::createMenus()
{
	...
	menuFile->addAction(createAction("exit", tr("Quit"), QApplication::applicationDirPath() + "/styles/default/images/exit.png"));
...
void MainWindow::createMenuView()
{
	...
	{
		QFile file(configPath()+"windows_layout.xml");
...
QAction *MainWindow::createAction( const QString &action_name , const QString &name , const QString &icon )
{
	return createAction(action_name, name.toLocal8Bit().data(), icon);
}

QAction *MainWindow::createAction(const QString &action_name, const char *name, const QString &icon )
{
...
QMenu *MainWindow::createMenu(const QString &menu_name , const QString &name , const QString &icon )
{
	return createMenu(menu_name, name.toLocal8Bit().data(), icon);
}

QMenu *MainWindow::createMenu(const QString &menu_name, const char *name,const QString &icon )
{
...
void MainWindow::setWindowsLayout(QAction *action)
{
	...
	if(action==actionSaveWindowsLayout)
	{
		...
		if (ok && !config_name.isEmpty())
		{
			...
			{
				QFile file(configPath()+"last_windows_layout.xml");
			...
			QFile last_wl_file(configPath()+"last_windows_layout.xml");
...
{
	if(QMessageBox::question(this, tr("Close"), tr("You are going to close all QtOctave's windows. Are you sure?"), QMessageBox::Yes, QMessageBox::No )!=QMessageBox::Yes)
	{
		event->ignore ();
		return;
	}
	...
	((Terminal *)session->getFirstTool(TERMINAL))->saveVariables();
...
static void writeXMLBaseWidget( BaseWidget *bw , const QString &parent , QXmlStreamWriter &xml )
{
...
void MainWindow::xmlWindowsPositions(const QString &config_name , QXmlStreamWriter &xml )
{
